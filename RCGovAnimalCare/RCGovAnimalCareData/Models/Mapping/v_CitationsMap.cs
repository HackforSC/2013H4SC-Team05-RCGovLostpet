...
{
    public class v_CitationsMap : EntityTypeConfiguration<v_Citations>
    {
        public v_CitationsMap()
        {
            // Primary Key
            this.HasKey(t => t.CitationID);

            // Properties
            this.Property(t => t.CitationID)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.Offender)
                .HasMaxLength(50);

            this.Property(t => t.Magistrate)
                .HasMaxLength(150);
            ...
            this.Property(t => t.Ordinance).HasColumnName("Ordinance");
